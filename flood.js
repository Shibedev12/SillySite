...
flood.msg = {};
flood.msg.info = "&#x1FAA3;";
    flood.texture = "https://shibedevsite.nekoweb.org/imgs/binary.png";
    flood.textureWidth = 256; // Resize to match your image file
    flood.textureHeight = 256;
    flood.msg.info = "?";
    flood.msg.rising = "The leak is growing!";
    flood.msg.falling = "Patching Leak....!";
    flood.msg.toosoon = "You might make it worse! please wait!";
    flood.msg.one = "A data leak has sprung!";
flood.msg.two = "This looks bad!";
flood.msg.three = "Data overflow soon!";
flood.msg.four = "I don't think my site will make it...";
flood.msg.five = "I T S  A L L  B I N A R Y";
flood.msg.six = "SYTEM SHUTDOWN -T 0 REASON (DATA_OVERFLOW)";
